  ...
  return plans.map((plan) => {
    const expectation =
      plan.targetPrice && plan.entryPrice
        ? ((plan.targetPrice.toNumber() - plan.entryPrice.toNumber()) /
            plan.entryPrice.toNumber()) *
          100
        : 0
...
export const updatePlan = async (
  ...
  return {
    ...
    expectation:
      updatedPlan.targetPrice && updatedPlan.entryPrice
        ? ((updatedPlan.targetPrice.toNumber() -
            updatedPlan.entryPrice.toNumber()) /
            updatedPlan.entryPrice.toNumber()) *
          100
        : 0,
